    ...
    paragraphTranslations: JSON.stringify([
      {
        ...
        translation: "中美高级官员本周在日内瓦举行高层贸易谈判，这是自三月最新一轮关税上调生效以来的首次正式对话。会谈重点讨论了农产品进口、技术转让和知识产权保护等问题。"
      },
      {
        paragraph: "Both sides issued a joint statement committing to constructive engagement and a follow-up meeting in June.",
        translation: "双方发表联合声明，承诺进行建设性接触，并将于六月举行后续会议。"
      },
      {
        paragraph: "Analysts noted that the resumption of dialogue itself is a positive signal, though significant hurdles remain regarding semiconductor export controls.",
        translation: "分析人士指出，对话恢复本身就是一个积极信号，尽管在半导体出口管制方面仍存在重大障碍。"
      },
      {
        paragraph: "The negotiations come at a critical juncture for the global economy, with supply chains still recovering from pandemic-era disruptions.",
        translation: "此次谈判正值全球经济的关键时刻，供应链仍在从疫情时期的中断中恢复。"
      }
    ]),
    complexSentences: JSON.stringify([
      {
        sentence: "Senior officials from the United States and China convened in Geneva this week for high-level trade negotiations, marking the first formal dialogue since the latest round of tariff hikes took effect in March.",
        structure: "主句 + 现在分词短语（作状语）+ since 时间状语从句",
        explanation: "句子主干是 officials convened。marking 是现在分词短语，表示伴随结果。since 引导时间状语从句，说明从三月关税生效以来。",
        keyWords: ["convened", "marking", "took effect"]
      },
      {
        sentence: "Analysts noted that the resumption of dialogue itself is a positive signal, though significant hurdles remain regarding semiconductor export controls.",
        structure: "主句 + that 宾语从句 + though 让步状语从句",
        explanation: "主句是 Analysts noted that。that 引导宾语从句，though 引导让步状语从句，表示转折关系。regarding 介词短语修饰 hurdles。",
        keyWords: ["resumption", "hurdles", "regarding"]
      }
    ]),
...
The Fed decision will have significant implications for global markets, as many emerging economies have been struggling with capital outflows driven by higher US interest rates. A rate cut could provide much-needed relief to these markets.`,
    ...
    paragraphTranslations: JSON.stringify([
      {
        paragraph: "The Federal Reserve signaled Wednesday that interest rate cuts could begin as early as September, citing meaningful progress in bringing inflation toward the 2% target.",
        translation: "美联储周三发出信号，最早可能在9月开始降息，理由是在将通胀率降至2%目标方面取得了重大进展。"
      },
      {
        paragraph: "Wall Street reacted positively to the announcement, with the S&P 500 reaching a record high.",
        translation: "华尔街对这一消息反应积极，标普500指数创下历史新高。"
      },
      {
        paragraph: "However, some economists warned that premature easing could reignite price pressures, particularly in housing and energy markets.",
        translation: "然而，一些经济学家警告称，过早放松可能会重新引发价格压力，尤其是在住房和能源市场。"
      },
      {
        paragraph: "The Fed decision will have significant implications for global markets, as many emerging economies have been struggling with capital outflows driven by higher US interest rates.",
        translation: "美联储的决定将对全球市场产生重大影响，因为许多新兴经济体一直在应对美国高利率驱动的资本外流。"
      }
    ]),
    complexSentences: JSON.stringify([
      {
        sentence: "The Federal Reserve signaled Wednesday that interest rate cuts could begin as early as September, citing meaningful progress in bringing inflation toward the 2% target.",
        structure: "主句 + that 宾语从句 + 现在分词短语（作原因状语）",
        explanation: "主句是 The Fed signaled that。that 引导宾语从句，citing 是现在分词短语，表示原因。as early as 表示最早在。",
        keyWords: ["signaled", "citing", "meaningful progress"]
      },
      {
        sentence: "The Fed decision will have significant implications for global markets, as many emerging economies have been struggling with capital outflows driven by higher US interest rates.",
        structure: "主句 + as 原因状语从句 + 过去分词短语（作后置定语）",
        explanation: "主句是 The decision will have implications。as 引导原因状语从句，driven by 是过去分词短语，修饰 capital outflows。",
        keyWords: ["implications", "struggling with", "driven by"]
      }
    ]),
    annotations: JSON.stringify({
      vocabulary: [
...
Industry analysts predict that on-device AI will become a standard feature across all smartphone manufacturers within the next two years. The technology could also extend to other devices, including laptops, tablets, and smart home products.`,
    ...
    paragraphTranslations: JSON.stringify([
      {
        paragraph: "Apple announced Monday that its upcoming iPhone 17 will feature a dedicated neural processing unit capable of running large language models entirely on-device.",
        translation: "苹果周一宣布，即将推出的iPhone 17将配备专用神经处理单元，能够完全在设备上运行大型语言模型。"
      },
      {
        paragraph: "Privacy advocates praised the development, while competitors scrambled to announce similar capabilities.",
        translation: "隐私倡导者对此举表示赞赏，而竞争对手则争相宣布类似功能。"
      },
      {
        paragraph: "The announcement came amid heightened regulatory scrutiny of AI data practices in the European Union.",
        translation: "这一消息发布之际，欧盟正加强对AI数据实践的监管审查。"
      },
      {
        paragraph: "Industry analysts predict that on-device AI will become a standard feature across all smartphone manufacturers within the next two years.",
        translation: "行业分析师预测，未来两年内，设备端AI将成为所有智能手机制造商的标准功能。"
      }
    ]),
    complexSentences: JSON.stringify([
      {
        sentence: "Apple announced Monday that its upcoming iPhone 17 will feature a dedicated neural processing unit capable of running large language models entirely on-device.",
        structure: "主句 + that 宾语从句 + 形容词短语（作后置定语）",
        explanation: "主句是 Apple announced that。that 引导宾语从句，capable of 是形容词短语，修饰 unit。",
        keyWords: ["feature", "dedicated", "capable of"]
      },
      {
        ...
        structure: "主句 + which 非限制性定语从句 + how 宾语从句",
        explanation: "主句是 The Act imposes requirements。which 引导非限制性定语从句，补充说明法案生效时间。how 引导宾语从句，说明要求的具体内容。",
        keyWords: ["took effect", "imposes", "requirements on"]
      }
    ]),
    annotations: JSON.stringify({
      vocabulary: [
...
The repatriation follows similar actions by German and French institutions, signaling a broader shift in museum ethics. However, critics questioned whether Western museums can maintain their encyclopedic collections under evolving legal standards.`,
    ...
    paragraphTranslations: JSON.stringify([
      {
        paragraph: "The British Museum formally returned 36 Benin Bronzes to Nigeria on Tuesday, ending a decades-long dispute over artifacts looted during the 1897 punitive expedition.",
        translation: "大英博物馆周二正式将36件贝宁青铜器归还给尼日利亚，结束了因1897年惩罚性远征期间被掠夺文物而持续数十年的争端。"
      },
      {
        paragraph: "The bronze sculptures, dating back to the 16th century, were originally created by artists of the Benin Kingdom to decorate the royal palace.",
        translation: "这些可追溯至16世纪的青铜雕塑最初由贝宁王国的艺术家创作，用于装饰皇宫。"
      },
      {
        paragraph: "Museum curators acknowledged mounting pressure from source communities and former colonial subjects.",
        translation: "博物馆馆长承认来自原产地社区和前殖民地臣民的压力日益增大。"
      },
      {
        paragraph: "The repatriation follows similar actions by German and French institutions, signaling a broader shift in museum ethics.",
        translation: "此次归还行动继德国和法国机构的类似举措之后，标志着博物馆伦理的更广泛转变。"
      }
    ]),
    complexSentences: JSON.stringify([
      {
        sentence: "The British Museum formally returned 36 Benin Bronzes to Nigeria on Tuesday, ending a decades-long dispute over artifacts looted during the 1897 punitive expedition.",
        structure: "主句 + 现在分词短语（作结果状语）+ 过去分词短语（作后置定语）",
        explanation: "主句是 The Museum returned Bronzes。ending 是现在分词短语，表示结果。looted 是过去分词短语，修饰 artifacts。",
        keyWords: ["returned", "ending", "looted", "punitive expedition"]
      },
      {
        sentence: "They were seized by British forces during a military campaign that has been widely condemned as an act of cultural vandalism.",
        structure: "被动语态主句 + that 定语从句",
        explanation: "主句是 They were seized。that 引导定语从句，修饰 campaign。condemned as 表示被谴责为。",
        keyWords: ["seized", "condemned", "vandalism"]
      }
    ]),
    annotations: JSON.stringify({
      vocabulary: [
...
Economists warn of a potential commercial real estate crisis, as office buildings struggle with low occupancy rates. We are witnessing a fundamental restructuring of how people live and work, said Professor David Miller of Columbia University urban planning department.`,
    ...
    paragraphTranslations: JSON.stringify([
      {
        paragraph: "A comprehensive study published Thursday reveals that remote work policies have fundamentally altered housing demand in major metropolitan areas.",
        translation: "周四发表的一项综合研究表明，远程工作政策从根本上改变了大都市地区的住房需求。"
      },
      {
        paragraph: "Real estate analysts coined the term Zoom rooms to describe the new must-have feature in suburban homes.",
        translation: "房地产分析师创造了Zoom房间一词来描述郊区住宅的新必备功能。"
      },
      {
        paragraph: "The trend has prompted urban planners to reconsider mixed-use zoning laws.",
        translation: "这一趋势促使城市规划者重新考虑混合用途分区法规。"
      },
      {
        paragraph: "Economists warn of a potential commercial real estate crisis, as office buildings struggle with low occupancy rates.",
        translation: "经济学家警告可能出现商业地产危机，因为写字楼正面临低入住率的困境。"
      }
    ]),
    complexSentences: JSON.stringify([
      {
        sentence: "Downtown apartment vacancies in New York and San Francisco reached 15-year highs, while suburban markets experienced bidding wars for properties with home offices.",
        structure: "主句 + while 对比状语从句",
        explanation: "两个分句通过 while 连接，形成对比：市中心空置率高 vs 郊区竞价激烈。15-year highs 是复合名词，表示15年来最高。",
        keyWords: ["vacancies", "bidding wars", "while"]
      },
      {
        sentence: "Some cities are exploring incentives to convert vacant commercial space into residential units, while others are investing in public amenities to attract residents back to downtown areas.",
        structure: "主句 + to do 不定式（作目的状语）+ while 对比结构",
        explanation: "convert into 表示将...转变为...。to attract 是目的状语。while 连接两个对比的做法。",
        keyWords: ["incentives", "convert", "amenities"]
      }
    ]),
    annotations: JSON.stringify({
      vocabulary: [

...
export async function GET() {
  try {
    ...
    const vocabCount = await prisma.vocabulary.count({ where: { userId: TEMP_USER_ID } });
    ...
    const realStats = { weeklyReads, totalReads: readNewsIds.length, totalMinutes, streak, vocabCount };
